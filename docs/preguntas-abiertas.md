...
| d | Tokens TOTP (RFC 6238) generados desde FreeOTP en el teléfono del usuario. | Implementado | [`manual-freeotp.md`](manual-freeotp.md) y [`memoria-tecnica.md`](memoria-tecnica.md) sección 5 |
