...
|---|---|---|
| Repositorio en GitHub | ✅ Operativo | `chochy2001/otp-secured-cloud`, 5 commits en `main` |
| Colaboradores del equipo | 🟡 1 de 5 aceptados | Arely aceptada; Mauricio, María Elena, Esteban, Luis Iván pendientes |
| OpenLDAP | ✅ Funcional | `scripts/ldap-verify.sh` pasa con `Todo OK` |
| PrivacyIDEA | ⏳ Por implementar | — |
| Certificados TLS (CA propia) | ⏳ Por implementar | — |
...
| Documentación del entregable | 🟡 Parcial | Conceptos básicos, árbol, arquitectura, guía de equipo listos; falta memoria técnica consolidada, conclusiones, glosario, bibliografía |
| Presentación de 30 min | ⏳ Por preparar | — |

**Leyenda:** ✅ Hecho y verificado · 🟡 En progreso · ⏳ Pendiente pero no bloqueado · ⛔ Bloqueado por decisión externa
...
| Índice | ⏳ Pendiente (se genera al final) | — |
| Índice de figuras con referencia | ⏳ Pendiente | — |
| Conceptos básicos de 2FA mediante tokens OTP | ✅ Redactado | [`conceptos-basicos.md`](conceptos-basicos.md) |
| Diagrama detallado de la solución | 🟡 Diagrama ASCII listo, falta versión renderizada | [`arquitectura.md`](arquitectura.md) |
| Memoria técnica (how-to) paso a paso | 🟡 Parcial: LDAP documentado, falta PrivacyIDEA, TLS y OwnCloud | varios |
| Conclusiones individuales y por equipo | ⏳ Pendiente | — |
...
| ii. Integración con PrivacyIDEA | ⏳ Siguiente fase | |
| iii. Emisión de token OTP desde FreeOTP | ⏳ Depende de PrivacyIDEA | |
| iv. Implementación de OwnCloud | ⛔ Bloqueado | Espera decisión 10 vs OCIS |
| v. Integración 2FA LDAP + OTP | ⛔ Depende de iii y iv | |
...
- [x] OU Servicios + cuenta `svc-owncloud` de solo lectura
- [x] Script `scripts/ldap-verify.sh` que valida admin, usuarios, servicio y rechazo de credenciales inválidas
...
Ver [`preguntas-abiertas.md`](preguntas-abiertas.md) para el detalle y el PDF `preguntas_profesor_v2.pdf` enviado.
...
### 2026-04-24
- Repositorio creado en GitHub con 4 commits modulares limpios.
- Historia de commits auditada: sin referencias a IA, Claude ni Anthropic.
...
- PDF `preguntas_profesor_v2.pdf` preparado y compartido con el profesor fuera del repo.
