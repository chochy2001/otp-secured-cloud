...
Pese a las limitaciones aceptadas, el resultado me deja contento: un laboratorio que cubre las cuatro capas del control de acceso, que se levanta con seis comandos, que se valida con scripts y que documenta tanto sus fortalezas como sus huecos. Es exactamente lo que esperaría que aprendiera un estudiante de Seguridad Informática Avanzada al cierre del semestre.
